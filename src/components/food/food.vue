...
import Split from "comp/split/split";
import popupMixin from "comm/mixins/popup";
import cartControl from "comp/cart-control/cart-control";
import RatingSelect from "comp/rating-select/rating-select";
